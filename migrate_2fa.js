...
async function migrate() {
    try {
        ...
        try {
            ...
            console.log("Coluna ativo_2fa possivelmente já existe:", e.message);
        }
        ...
        try {
            ...
            console.log("Coluna codigo_2fa possivelmente já existe:", e.message);
        }
        ...
        try {
            ...
            console.log("Coluna codigo_2fa_expira possivelmente já existe:", e.message);
        }
