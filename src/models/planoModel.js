const planosGames = Object.freeze([
  ...
  Object.freeze({
    ...
    precoAnual: 49.9,
    moedas: 1000,
    recursos: ["1.000 Moedas/mês", "Acesso Básico Estendido", "1 Skin de Arma Comum"],
    popular: false,
    isGratis: false,
  }),
  Object.freeze({
    ...
    precoAnual: 199.0,
    moedas: 5000,
    recursos: ["5.000 Moedas/mês", "Conjuntos de Personagens Épicos", "Acesso a Ligas Exclusivas"],
    popular: true,
    isGratis: false,
  }),
  Object.freeze({
    ...
    precoAnual: 399.0,
    moedas: 15000,
    recursos: ["Moedas Ilimitados", "Todos os Personagens Desbloqueados", "Sem Anúncios"],
    popular: false,
    isGratis: false,
  }),
]);
