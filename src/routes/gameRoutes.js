...
], tratarErrosValidacao, gameController.validarApiKey, gameController.getSaldo);
...
], tratarErrosValidacao, gameController.validarApiKey, gameController.consumirTokens);
...
], tratarErrosValidacao, gameController.validarApiKey, gameController.salvarEstatisticas);
